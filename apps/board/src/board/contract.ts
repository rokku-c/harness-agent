...
import type { AgentInstance, Concurrency, ExecutionRecord, ExecutorKind, ResourceKind, WorkItem, WorkItemKind } from "../domain.ts"
...
export interface BoardSnapshot {
  ...
  readonly executions: ReadonlyArray<ExecutionRecord>
