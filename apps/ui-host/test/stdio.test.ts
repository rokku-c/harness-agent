...
test("ui host advertises the external MCP surface", async () => {
  ...
  try {
    ...
    await call(child, "tools/call", { name: "ui_create_canvas", arguments: { canvasId: "details", title: "Details" } }, 8)
    const linked = await call(child, "tools/call", { name: "ui_link_canvas", arguments: { canvasId: "demo", nodeId: "details-link", targetCanvasId: "details" } }, 9)
